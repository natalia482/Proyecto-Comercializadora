          ...
          <div class="col-md-12 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Comprar Cactus o Suculentas</h2></div>
              </div>
            </div>
            <div class="row mb-5">
              ...
              $resultado = ('SELECT * FROM  PRODUCTO WHERE TIPOPLANTA= "Cactus" OR TIPOPLANTA = "Suculentas"  AND ESTADO = "EN VENTA" order by IDPRODUCTO DESC') ;
                    ...
                    <div class="block-4 text-center border">
                      ...
                      <figure class="block-4-image ">
                       ...
                       '<img src="data:image/jpg;base64,
                            '.base64_encode($fila['IMG']).'"  width=250px height=250px>'?>
                          </a>
                         </figure>'
