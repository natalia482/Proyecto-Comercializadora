          ...
          <div class="col-md-12 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Comprar Bonsai</h2></div>
              </div>
            </div>
            <div class="row mb-5">
              ...
              $resultado = ('SELECT * FROM  PRODUCTO WHERE TIPOPLANTA= "Bonsai" AND ESTADO = "EN VENTA" order by IDPRODUCTO DESC') ;
